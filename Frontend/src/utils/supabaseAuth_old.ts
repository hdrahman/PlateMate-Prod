...
import { GOOGLE_WEB_CLIENT_ID } from            console.log('🟢 Supabase Google OAuth initiated successfully');
            return data;
        } catch (error) {
            console.error('🔴 Error signing in with Google:', error);
            throw error;
        }
    },t Google Sign In safely
...
export const supabaseAuth = {
    ...
    signInWithGoogle: async () => {
        try {
            ...
            console.log('🟡 Supabase Google OAuth initiated:', { data, error });
