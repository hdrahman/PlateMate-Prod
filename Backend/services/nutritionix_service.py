    ...
    def search_food(self, query: str, min_healthiness: int = 0) -> List[Dict[str, Any]]:
        ...
        try:
            ...
            for item in branded_foods:
                ...
                logger.info(f"Processing branded food: {food_name} (brand: {brand_name}, nix_item_id: {nix_item_id})")
                
                # For branded foods, use the specific nix_item_id to get exact nutritional data
                if nix_item_id:
            ...
            for item in common_foods:
                ...
                if food_name:
                    ...
                    if detailed_food:
                        ...
                        logger.warning(f"Failed to get detailed data for common food: {food_name}, skipping")
                        continue
